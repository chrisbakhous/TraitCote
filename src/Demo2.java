...
public class Demo2 {
	...
	public static void main(String[] args) {
		...
		//Segments parallèle à l'abscisse 
		Point p1 = new Point(10.0,10.0); //x1 < x2 
		Point p2 = new Point(15.0,10.0);
		
		Point p3 = new Point(30.0,10.0); //x1 > x2 
		Point p4 = new Point(25.0,10.0);
		
		Segment s1 = new Segment(p1, p2);
		Segment s2 = new Segment(p3, p4);
		
		//Segments parallèle à l'ordonné 
		Point p5 = new Point(10.0,25.0); //y1 > y2 
		Point p6 = new Point(10.0,20.0);
		
		Point p7 = new Point(25.0,20.0); //y1 < y2 
		Point p8 = new Point(25.0,25.0);
